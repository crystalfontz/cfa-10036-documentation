...
inline __s32 i2c_smbus_read_block_data(int file, __u8 command, __u8 *values);
inline __s32 i2c_smbus_write_block_data(int file, __u8 command, __u8 length, const __u8 *values);
