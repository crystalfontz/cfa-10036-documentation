 ...
 **/
extern bool gpio_config(unsigned int pin,unsigned int state){
 ...
 **/
extern bool gpio_write(unsigned int portnum,unsigned int state){
 ...
 **/
extern int gpio_read(unsigned int portnum){
